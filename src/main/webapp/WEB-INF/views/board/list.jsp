...
<body>
			...
			<table class="table table-striped table-hover">
				...
				<tbody>
					<c:forEach items="${list}" var="board">
						<tr>
							<td>${board.bno}</td>
							<td><a href="${root }/board/get?bno=${board.bno }"> <c:out
										value="${board.title}" />
							</a></td>
	...
	<div class="container-sm mt-3">
		<div class="row justify-content-center">
			<nav aria-label="page navigation ezample">
				<ul class="pagination">
					...
					<c:if test="${pageMaker.prev }">
						...
						<li class="page-item">
						<%--<a class="page-link" href="${prevLink }">Previous</a></li> --%> 
					...
					<c:if test="${pageMaker.next }">
						...
						<li class="page-item">
								<%--<a class="page-link" href="${nextLink }">Next</a></li> --%>
...
<div class="d-none">
	<form id="actionForm" action="${root}/board/list" >
		<input name ="pageNum" value="${pageNum.cri.pageNum}" />
